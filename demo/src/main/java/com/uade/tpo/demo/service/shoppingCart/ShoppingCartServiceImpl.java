...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public void clearCartByUserId(Long userId) {
        ...
        // Vacía el carrito pero no repone el stock porque ya se generó la orden
        cart.getItems().clear();
        cart.setTotalPrice(0.0); // Restablece el total del carrito a 0
        shoppingCartRepository.save(cart); // Guarda el carrito vacío en la base de datos
    }
