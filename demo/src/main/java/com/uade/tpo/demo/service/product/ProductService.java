...
public interface ProductService {
    ...
    public Product createProduct(String description, String model, String genre, String image, Double double1, Integer integer, Category category) throws InvalidProductDataException,InvalidPriceException,InsufficientStockException;
